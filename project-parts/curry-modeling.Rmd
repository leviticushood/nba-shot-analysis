...
# ─────────────────────────────────────────────────────────────────────────────
# Clutch Model Performance Summary (n=100, 3-feature models, no retraining)
...
# Note: more balanced class distribution (56/44) vs prior definition (93/58)
#       improved specificity across all models compared to previous results

# Clutch Analysis Observations:
#  - General models trained on ~48% make rate, clutch subset has ~44% make rate
#    class distributions are closer but mismatch still limits clutch prediction reliability
...
#  - n=100 clutch observations is insufficient for statistically significant claims
